...
function myFunction() {
      ...
      document.getElementById("myBar").style.width = amountscrolled + "%";
 }
  ...
  var modebutton = 'dark_mode_pref';
  var onbutton = 'true';
  var offbutton = 'false';
  var pref = sto.getItem(modebutton);
    ...
    if (pref == onbutton) activateTheme(cls_dark);
    if (pref == offbutton) activateTheme(cls_light);
    ...
    if (toggle) {
      ...
      toggle.addEventListener('click', function() {
        if (!dark) {
          activateTheme(cls_dark);
          sto.setItem(pref_key, onbutton);
        } else {
          activateTheme(cls_light);
          sto.setItem(pref_key, offbutton);
        }
      }, true);
    }
  })();
